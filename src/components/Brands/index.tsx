        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="flex items-center justify-center rounded-xs bg-gray-light px-8 py-8 dark:bg-gray-dark sm:px-10 md:px-[50px] md:py-[40px] xl:p-[50px] 2xl:px-[70px] 2xl:py-[60px]">
              <span className="text-center text-xl md:text-2xl font-bold text-primary">
                Ha vízszerelésre van szüksége Budapesten vagy Pest megyében, a H2O Gyorsszervíz azonnal segít!
              </span>
            </div>
          </div>
        </div>
